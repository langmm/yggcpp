...
contains
  ...
  function create_dtype_empty(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_empty_c(logical(use_generic, kind=1))
  ...
  function create_dtype_python(pyobj, use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_python_c(pyobj, logical(use_generic, kind=1))
  ...
  function create_dtype_direct(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_direct_c(logical(use_generic, kind=1))
  ...
  function create_dtype_json_array(nitems, items, use_generic) &
    ...
    type(yggdtype), dimension(:), intent(in), target :: items
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    ...
    ! end do
    out = create_dtype_json_array_c(c_nitems, c_loc(items(1)), &
         logical(use_generic, kind=1))
  ...
  function create_dtype_json_object(nitems, keys, values, use_generic) &
    ...
    type(yggdtype), dimension(:), intent(in), target :: values
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    integer(kind=c_size_t) :: c_nitems
    ...
    ! end do
    out = create_dtype_json_object_c(c_nitems, c_loc(c_keys(1)), &
         c_loc(values(1)), logical(use_generic, kind=1))
  ...
  function create_dtype_ply(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_ply_c(logical(use_generic, kind=1))
  ...
  function create_dtype_obj(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_obj_c(logical(use_generic, kind=1))
  ...
  function create_dtype_schema(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_schema_c(logical(use_generic, kind=1))
  ...
  function create_dtype_any(use_generic) result(out)
    ...
    logical, intent(in) :: use_generic
    type(yggdtype) :: out
    out = create_dtype_any_c(logical(use_generic, kind=1))
  ...
  function ygg_recv(ygg_q, data, data_len) result (flag)
    ...
    c_data = data//c_null_char
    c_data_len = data_len
    c_flag = ygg_recv_c(ygg_q, c_data, c_data_len)
    if (c_flag.ge.0) then
       flag = .true.
       data = c_data(:c_flag)
       data_len = c_flag
