...
macro(find_compiler_external_propagate_vars IDSTR)
  ...
  set(CMAKE_${IDSTR}_COMPILER_ID ${CMAKE_${language}_COMPILER_ID_${IDSTR}})
  ...
  endforeach()
  foreach(ivar COMPILER COMPILER_ID LINKER GENERATOR IMPLICIT_LIBRARIES)
...
function(find_compiler_external language)
  ...
  if(NOT ARGS_ID)
    if(ARGS_LINKER_LANGUAGE)
      set(ARGS_ID "${language}_${ARGS_LINKER_LANGUAGE}")
    else()
      set(ARGS_ID "${language}")
    endif()
  endif()
  ...
  set(cached_external_var "_${IDSTR}_EXT_VARS")
  ...
  if((NOT DEFINED CACHE{${cached_output_var}}) OR
    ...
    set(tmp_dir "${CMAKE_CURRENT_BINARY_DIR}/_chk_${IDSTR}")
...
function(check_language_external language)
  ...
  set(oneValueArgs TIMEOUT LINKER_LANGUAGE ID OUTPUT_VARIABLE
      OUTPUT_COMPILER OUTPUT_COMPILER_ID OUTPUT_LINKER OUTPUT_GENERATOR
...
function(add_mixed_language_library target library_type)
  ...
  if(FORCE_SPLIT_CXXFortran AND (NOT Fortran_IDX EQUAL -1))
...
function(add_import_library target library_type library)
  ...
  inspect_target(${target} PREFIX "IMPORTED ${target}: ")
endfunction()
