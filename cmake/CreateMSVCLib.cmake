function(convert_dlla_to_lib libname)
  ...
  if(ARGS_DIRECTORIES)
    find_library(dllafile ${libname} PATHS ${if(ARGS_DIRECTORIES)})
  else()
...
function(create_lib_for_target target)
  ...
  if (ARGS_LIBFILE)
    ...
    set_target_properties(target IMPORT_SUFFIX ".lib")
  endif()
  if (ARGS_DEFFILE)
    set(deffile ${ARGS_DEFFILE})
  else()
    cmake_path(APPEND deffile "${CMAKE_CURRENT_BINARY_DIR}" "${CMAKE_SHARED_LIBRARY_PREFIX}${target}.def")
  endif()
  if (ARGS_EXPFILE)
    set(expfile ${ARGS_EXPFILE})
  else()
    cmake_path(APPEND expfile "${CMAKE_CURRENT_BINARY_DIR}" "${CMAKE_SHARED_LIBRARY_PREFIX}${target}.exp")
  endif()
