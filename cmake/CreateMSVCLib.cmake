function(convert_dlla_to_lib libname)
  ...
  if(dllafile MATCHES ".*\\.dll\\.a$")
    include(${CMAKE_CURRENT_FUNCTION_LIST_DIR}/ListSearchPaths.cmake)
    set(dllvarname ${libname}_dll)
    set(${dllvarname})
    find_library_suffix(${dllvarname} ${libname} SHARED PATHS ${ARGS_DIRECTORIES})
    ...
    if(EXISTS "${libfile}")
      ...
      return()
    elseif(EXISTS "${libfile_alt}")
      message(STATUS "DLLA2LIB: ${libfile_alt} already exists (ALT)")
      return()
    endif()
