...
function(generate_target_file target_file)
  ...
  message(STATUS "ARGS_FULL_LIBRARY_IGNORE_SUFFIXES = ${FULL_LIBRARY_IGNORE_SUFFIXES}")
  ...
  if(ARGS_TARGETS OR ARGS_EXTRA_LIBRARIES OR ARGS_EXTRA_DIRECTORIES)
    ...
    if(ARGS_EXTRA_LIBRARIES AND ARGS_FULL_LIBRARIES)
      ...
      find_full_libraries(LIBRARIES ${ARGS_EXTRA_LIBRARIES}
			  ...
			  ${args_full})
      set(CONTENTS "FULL_LIBRARIES;${ARGS_EXTRA_FULL_LIBRARIES};DIRECTORIES;${ARGS_EXTRA_DIRECTORIES}")
    else()
...
function(target_link_from_file target scope)
  ...
  if(FULL_LIBS)
    ...
    if(scope STREQUAL "IMPORTED")
      ...
      if(EXISTING_LIBS)
        list(PREPEND LIBS ${EXISTING_LIBS})
        message(STATUS "Linking libraries (with existing) ${FULL_LIBS}")
      endif()
      set_target_properties(${target} PROPERTIES
                            INTERFACE_LINK_LIBRARIES "${FULL_LIBS}")
    else()
      target_link_libraries(${target} ${scope} ${FULL_LIBS})
    endif()
  endif()
  if(DIRS)
