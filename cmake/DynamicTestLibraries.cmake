...
function(add_dynamic_test_library TARGET)
  ...
  if (NOT BUILD_${ARGS_LANGUAGE}_LIBRARY)
    message(STATUS "BUILD_${ARGS_LANGUAGE}_LIBRARY not set, skipping dynamic test library ${TARGET}")
    return()
  endif()
  if (ARGS_GENERATE)
    if (ARGS_LANGUAGE STREQUAL "C" OR ARGS_LANGUAGE STREQUAL "CXX")
      list(APPEND ARGS_LIBRARIES ${YGG_TARGET_CXX})
...
function(add_embedded_test_script TARGET)
  ...
  if ((ARGS_LANGUAGE STREQUAL "Python") AND
  ...
  if(NOT YGG_EMBED_${ARGS_LANGUAGE})
