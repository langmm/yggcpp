function(set_tests_environment TEST_NAME)
  ...
  message(STATUS "set_tests_environment ARGS_OUTPUT_PROPERTIES = ${ARGS_OUTPUT_PROPERTIES}")
  if(ARGS_OUTPUT_PROPERTIES)
    message(STATUS "skipping set_tests_properties")
    ...
    if (ARGS_FOR_GTEST_DISCOVER_TESTS)
      ...
      message(STATUS "Calling set_tests_properties ${properties}")
      set_tests_properties(
...
function(set_tests_runtime_paths TEST_NAME)
  ...
  set(oneValueArgs PATH_VARIABLE OUTPUT_PROPERTIES)
  ...
  message(STATUS "BEFORE ARGS_OUTPUT_PROPERTIES = ${ARGS_OUTPUT_PROPERTIES}")
  if(ARGS_OUTPUT_PROPERTIES)
