function(set_tests_environment TEST_NAME)
  ...
  if(ARGS_OUTPUT_PROPERTIES)
    ...
    message(DEBUG "skipping set_tests_properties ${ARGS_OUTPUT_PROPERTIES} = ${${ARGS_OUTPUT_PROPERTIES}}")
  else()
...
function(set_tests_runtime_paths TEST_NAME)
  ...
  message(DEBUG "ARGS_ADDITIONAL_ENV_VARIABLES = ${ARGS_ADDITIONAL_ENV_VARIABLES}")
  ...
  if(ARGS_OUTPUT_PROPERTIES)
    message(DEBUG "ARGS_OUTPUT_PROPERTIES = ${ARGS_OUTPUT_PROPERTIES}, ${ARGS_OUTPUT_PROPERTIES} = ${${ARGS_OUTPUT_PROPERTIES}}")
