...
function(load_cmake_variables CONTENTS)
  set(options VERBOSE REQUIRED)
  set(oneValueArgs PREFIX SUFFIX LOG_LEVEL PATTERN)
  ...
  if(NOT ARGS_PATTERN)
    set(ARGS_PATTERN "<key>=<value>")
  endif()
  if(NOT (ARGS_PATTERN MATCHES "<key>" AND
          ARGS_PATTERN MATCHES "<value>"))
    message(FATAL_ERROR "Pattern \"${ARGS_PATTERN}\" does not contain required \"<key>\" and \"<value>\"")
  endif()
...
function(dump_cmake_variables)
  set(options VERBOSE INCLUDE_VALUE)
  set(oneValueArgs REGEX PREFIX OUTPUT_VAR LOG_LEVEL OUTPUT_PATTERN
  ...
  if(ARGS_OUTPUT_PATTERN)
    if(ARGS_OUTPUT_PATTERN STREQUAL "ON")
      set(ARGS_OUTPUT_PATTERN "<key>=<value>")
    endif()
    if(NOT (ARGS_OUTPUT_PATTERN MATCHES "<key>" OR
            ARGS_OUTPUT_PATTERN MATCHES "<value>"))
      message(FATAL_ERROR "Output pattern \"${ARGS_OUTPUT_PATTERN}\" does not contain required \"<key>\" or \"<value>\"")
    endif()
    if(ARGS_INCLUDE_VALUE)
  ...
  foreach (_variableName ${_variableNames})
    ...
    if (ARGS_OUTPUT_VAR)
      if(ARGS_OUTPUT_PATTERN)
        set(val "${ARGS_OUTPUT_PATTERN}")
        string(REPLACE ";" "-SEMICOLON-" value_full "${${_variableName}}")
        string(REPLACE "<key>" "${_variableName}" val "${val}")
