...
function(select_files_by_language language destination)
  ...
  sort_files_by_language(SOURCES ${ARGS_SOURCES})
  set(sources)
  set(other_sources)
  foreach(ilanguage IN LISTS LANGUAGES)
    if(ilanguage STREQUAL "${language}")
      list(APPEND sources ${SOURCES_${ilanguage}})
    else()
      list(APPEND other_sources ${SOURCES_${ilanguage}})
    endif()
  endforeach()
