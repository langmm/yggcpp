...
if(Julia_EXECUTABLE)
    ...
    set(Julia_RUNTIME_LIBRARY "${Julia_LIBRARY}")
    if(WIN32)
    ...
    set(Julia_RUNTIME_LIBRARY "${Julia_RUNTIME_LIBRARY}"
        CACHE PATH "Julia runtime library")
else()
...
get_filename_component(Julia_LIBRARY_DIR ${Julia_LIBRARY} DIRECTORY)
if (Julia_RUNTIME_LIBRARY)
  get_filename_component(Julia_RUNTIME_LIBRARY_DIR ${Julia_RUNTIME_LIBRARY} DIRECTORY)
endif()

MESSAGE(STATUS "Julia_LIBRARY_DIR:    ${Julia_LIBRARY_DIR}")
MESSAGE(STATUS "Julia_LIBRARY:        ${Julia_LIBRARY}")
MESSAGE(STATUS "Julia_RUNTIME_LIBRARY_DIR: ${Julia_RUNTIME_LIBRARY_DIR}")
MESSAGE(STATUS "Julia_RUNTIME_LIBRARY:${Julia_RUNTIME_LIBRARY}")
...
set(Julia_EXECUTABLE "${Julia_EXECUTABLE}" CACHE PATH "Julia executable")
set(Julia_LLVM_VERSION "${Julia_LLVM_VERSION}" CACHE STRING "Julia's LLVM Version")
set(JULIA_HOME "${JULIA_HOME}" CACHE PATH "Julia home directory")
set(Julia_RUNTIME_LIBRARY_DIR "${Julia_RUNTIME_LIBRARY_DIR}" CACHE PATH "Julia runtime library directories")
