...
void python::exportCommunicators() {
    ...
    bp::class_<communicator::ClientComm, bp::bases<CommWrap,communicator::COMM_BASE>, boost::noncopyable>("ClientComm", bp::init<const std::string&, utils::Address*, int>()[bp::with_custodian_and_ward_postcall<0,2>()])
    ...
    bp::class_<communicator::ServerComm, bp::bases<CommWrap,communicator::COMM_BASE>, boost::noncopyable>("ServerComm", bp::init<const std::string&, utils::Address*, int>()[bp::with_custodian_and_ward_postcall<0,2>()])
            .def(bp::init<const std::string, int>())
