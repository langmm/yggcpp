...
size_t ObjMetaschemaType::update_from_serialization_args(size_t *nargs, va_list_t &ap) {
...
YggGeneric *ObjMetaschemaType::python2c(PyObject *pyobj) const {
    ...
    if (arg->alloc(nvert, ntexc, nnorm, nparam, npoint, nline, nface,
...
PyObject *ObjMetaschemaType::c2python(YggGeneric *cobj) const {
...
bool ObjMetaschemaType::encode_data(rapidjson::Writer<rapidjson::StringBuffer> *writer,
...
int ObjMetaschemaType::decode_line(obj_t *p, int &cline, char *iline,
...
int ObjMetaschemaType::decode_face(obj_t *p, int &cface, char *iline,
...
int ObjMetaschemaType::decode_surface(obj_t *p, int &csurf, char *iline,
...
bool ObjMetaschemaType::decode_data(rapidjson::Value &data, const int allow_realloc,
                                    size_t *nargs, va_list_t &ap) const {
    if (!(data.IsString()))
    ...
    // Allocate
    if (out > 0) {
        int ret = p->alloc(nvert, ntexc, nnorm, nparam, npoint,
