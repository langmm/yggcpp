...
Dict* PlyMetaschemaType::copy_generic(const YggGeneric* data, Dict* orig_data) const {
if (data == NULL) {
...
void PlyMetaschemaType::free_generic(YggGeneric* data) const {
if (data == NULL) {
...
size_t PlyMetaschemaType::update_from_serialization_args(size_t *nargs, va_list_t &ap) {
...
YggGeneric* PlyMetaschemaType::python2c(PyObject *pyobj) const {
...
PyObject* PlyMetaschemaType::c2python(YggGeneric *cobj) const {
...
bool PlyMetaschemaType::encode_data(rapidjson::Writer<rapidjson::StringBuffer> *writer,
...
bool PlyMetaschemaType::decode_data(rapidjson::Value &data, const int allow_realloc,
                 size_t *nargs, va_list_t &ap) const {
if (!(data.IsString()))
