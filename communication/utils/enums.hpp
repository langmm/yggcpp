...
enum THREAD_STATUS {
  THREAD_INACTIVE     = 0,
  THREAD_STARTED      = 0x00000001,
  THREAD_COMPLETE     = 0x00000002,
  THREAD_ERROR        = 0x00000004,
  THREAD_SIGNON_SENT  = 0x00000008,
  THREAD_SIGNON_RECV  = 0x00000010,
  THREAD_HAS_RESPONSE = 0x00000020
};
